...
function [trained_net, train_info] = train_dr_grading_cnn(ds_train, ds_val, backbone_name, train_options)
    ...
    % Configure domain-specific data augmentation for fundus images
    ...
    fprintf('Executing model training...\n');
    [trained_net, train_record] = trainNetwork(ds_train, lgraph, opts);
